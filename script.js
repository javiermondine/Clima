...
function wireEvents() {
  ...
  if (gifToggle) {
    // Auto-activar GIF si hay key disponible
    const hasGiphyKey = !!getGiphyKey();
    state.enableGiphy = hasGiphyKey || gifToggle.checked;
    if (hasGiphyKey) gifToggle.checked = true;
